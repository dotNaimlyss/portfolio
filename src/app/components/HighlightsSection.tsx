        ...
        <div className="mt-8 grid gap-3 sm:mt-10 sm:gap-4 md:grid-cols-3">
          {cards.map((card, index) => (
            <Reveal key={card.title} delayMs={index * 90}>
              <article className="rounded-2xl border border-white/60 bg-white/75 p-5 shadow-lg shadow-slate-900/10 backdrop-blur-xl transition duration-300 hover:-translate-y-1 sm:p-6 dark:border-white/10 dark:bg-slate-900/65 dark:shadow-black/25">
